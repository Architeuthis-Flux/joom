...
#define video_htiming_pio_version 1
...
static const struct pio_program video_htiming_program = {
    ...
    .length = 6,
    .origin = -1,
    .pio_version = video_htiming_pio_version,
...
#define video_htiming_states_pio_version 1
...
static const struct pio_program video_htiming_states_program = {
    ...
    .length = 4,
    .origin = -1,
    .pio_version = video_htiming_states_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
